@extends('layouts.app', ['title' => 'Banners Home'])

@section('content')
    <section class="card">
        <div style="display:flex; justify-content:space-between; align-items:center; gap:.7rem; flex-wrap:wrap;">
            <h1>Panel admin - Banner principal</h1>
            <a class="btn" href="{{ route('admin.home-banners.create') }}">Nuevo banner</a>
        </div>
                ...
                <tbody>
                    @forelse($banners as $banner)
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <a class="btn btn-outline" href="{{ route('admin.home-banners.edit', $banner) }}">Editar</a>
                    ...
                    @empty
                        <tr><td colspan="7">No hay banners configurados.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
